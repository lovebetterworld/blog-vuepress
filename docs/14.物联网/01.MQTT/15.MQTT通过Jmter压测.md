---
title: 15.MQTT通过Jmter压测
date: 2022-06-21 16:21:25
permalink: /mqtt/mqtt15/
categories:
  - 物联网
  - MQTT
tags:
...
- [如何在 JMeter 中使用 MQTT 插件 | EMQ (emqx.com)](https://www.emqx.com/zh/blog/how-to-use-the-mqtt-plugin-in-jmeter)
- [JMeter MQTT 在订阅与发布测试场景中的使用 | EMQ (emqx.com)](https://www.emqx.com/zh/blog/the-use-of-jmeter-mqtt-in-subscription-and-publishing-test-scenarios)
- [JMeter MQTT 在连接测试场景中的使用 | EMQ (emqx.com)](https://www.emqx.com/zh/blog/test-mqtt-connection-with-jmeter)
- [JMeter 测试组件介绍 | EMQ (emqx.com)](https://www.emqx.com/zh/blog/introduction-to-jmeter-test-components)
- [开源测试工具 JMeter 介绍 | EMQ (emqx.com)](https://www.emqx.com/zh/blog/introduction-to-the-open-source-testing-tool-jmeter)
...
### 2.1 MQTT 连接采样器(MQTT Connect)

连接采样器模拟物联网设备，发起 MQTT 连接。

![JMeter MQTT 连接](https://assets.emqx.com/images/ebd5536794031cd01db488838013cc27.png?imageMogr2/thumbnail/1520x)
...
### 2.2 MQTT 消息发布采样器(MQTT Pub Sampler)

消息发布采样器复用连接采样器中建立的 MQTT 连接，向目标 [MQTT 服务器](https://www.emqx.com/zh/mqtt/public-mqtt5-broker)发布消息。

![JMeter 发布 MQTT 消息](https://assets.emqx.com/images/71728f02bf2886a7ce5d1c15dbd66a2b.png?imageMogr2/thumbnail/1520x)
...
### 2.3 MQTT 消息订阅采样器(MQTT Sub Sampler)

消息发布采样器复用连接采样器中建立的 MQTT 连接，从目标 MQTT 服务器上订阅消息。

![JMeter MQTT 消息订阅](https://assets.emqx.com/images/d46ae48963d4690ecaaab85ec0f38e61.png?imageMogr2/thumbnail/1520x)
...
### 2.4 MQTT 断开连接采样器(MQTT DisConnect)

断开连接采样器中建立的 MQTT 连接。

![JMeter 断开 MQTT 连接](https://assets.emqx.com/images/9be500573f56629d38adab8e264bdbc2.png?imageMogr2/thumbnail/1520x)
