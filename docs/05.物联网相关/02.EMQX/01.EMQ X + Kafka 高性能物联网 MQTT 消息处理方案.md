---
title: 01.EMQX+Kafka 性能物联网MQTT消息处理方案
...
### 6.1 使用 kafka-console-consumer 启动消费
...
![image-20191126150044511](https://cdn.bigpar.cn/wivwiv-static/images/emqx_kafka/image-20191126150044511.png)
